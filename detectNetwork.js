...
var detectNetwork = function(cardNumber) {
  ...
  // Initializing the prefixes of the credit card number
  ...
  // Conditional statements to determine the credit card network of the given credit card number. Returns the name of the network in string.
  if (((firstTwoNumber == '38' || firstTwoNumber == '39')) && (cardNumber.length == 14)){
  ...
  } else if (((firstFourNumber == '4903') || (firstFourNumber =='4905') || (firstFourNumber =='4911') || (firstFourNumber == '4936') 
  	|| (firstSixNumber == '564182') || (firstSixNumber =='633110') || (firstFourNumber =='6333') || (firstFourNumber =='6759')) 
    ...
    return "Switch"
  	...
  	return "MasterCard"
  } else if (( (firstFourNumber == '6011') || ( (parseInt(firstThreeNumber) >= 644) && (parseInt(firstThreeNumber) <= 649) ) 
  	|| (firstTwoNumber == '65') ) && ((cardNumber.length == 16) || (cardNumber.length == 19))){
  	return "Discover"
  	...
  	return "Maestro"
  } else if ((((parseInt(firstSixNumber) >= 622126 ) && (parseInt(firstSixNumber) <= 622925)) || ((parseInt(firstThreeNumber) >= 624 ) 
  	&& (parseInt(firstThreeNumber) <= 626)) || ((parseInt(firstFourNumber) >= 6282) && (parseInt(firstFourNumber) <= 6288))) 
